translations = {
    "en": {
        ...
        "dataset_preview": "### Dataset preview (First 5 Rows)",
        "full_dataset": "### Full dataset",
        "dataset_not_found": "Dataset not found",
        "visualization_title": "📊 Data Visualizations",
    ...
    "uk": {
        ...
        "dataset_preview": "### Попередній перегляд набору даних (Перші 5 рядків)",
        "full_dataset": "### Повний набір даних",
        "dataset_not_found": "Набір даних не знайдено",
        "visualization_title": "📊 Візуалізація даних",
